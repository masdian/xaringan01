---
title: "Statistika Sosial"
subtitle: "Uji Hipotesis Data Tunggal"
author: "Riana Hadiana, S.Si., M.Si."
institute: "Universitas Sultan Ageng Tirtayasa"
date: "2021/07/25 (updated: `r Sys.Date()`)"
output:
...
$$\bar{X}=\frac{1}{n}\sum_{i=1}^nX_i$$
$$\bar{X_i}=\frac{1}{n}\sum_{i=1}^nX_{ij}$$
